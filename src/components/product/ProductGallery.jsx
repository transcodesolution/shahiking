  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative w-full overflow-hidden rounded-2xl bg-secondary group">
        ...
        <button
          onClick={handlePrev}
          className="absolute left-6 top-62 -translate-y-1/2 bg-secondary p-2 rounded-full shadow-md cursor-pointer"
        >
        ...
        <button
          onClick={handleNext}
          className="absolute right-6 top-62 -translate-y-1/2 bg-secondary p-2 rounded-full shadow-md cursor-pointer"
        >
