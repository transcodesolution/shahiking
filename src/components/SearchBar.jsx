  ...
  return (
    <div ref={wrapperRef} className={`relative ${className}`}>
      <form
        ...
        className="bg-secondary rounded-3xl flex justify-between items-center w-full lg:max-w-60 xl:max-w-80 border border-gray-300  transition-all shadow-sm px-2"
      >
        <input
          type="text"
          placeholder="Search"
