...
export default function Hero() {
  return (
    <div className="flex flex-col items-center justify-center relative z-0">
      <Image
        src="/Image/blogpage/blog_hero_img.webp"
        alt="Hero Background"
        width={1920}
        height={355}
        className="w-full h-110 md:h-88.75 object-cover"
      />
      <span className="absolute top-0 left-0 w-full h-full bg-[#00000080]"></span>
      <div className="absolute inset-0 top-40 md:top-30 text-center px-4 md:px-6 lg:px-8">
        ...
        <p className="paragraph md:text-xl text-secondary mb-8 py-2 mx-auto">
          Healthy recipes, nutrition tips, and clean eating inspiration
        </p>
      </div>
    </div>
  );
