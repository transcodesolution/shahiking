    ...
    <div className='py-20'>
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
         ...
         <div className='grid grid-cols-1 md:grid-cols-3 xl:grid-cols-6 gap-6 xl:gap-8 pt-5 mt-5'>
            <div className='border border-black p-4 rounded-2xl flex flex-col gap-2 items-center transition-all duration-300 group hover:bg-secondary hover:border-primary cursor-pointer'>
