        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3 py-8">
          {packagingData.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="group overflow-hidden rounded-xl border border-[#d8d8d8] bg-white transition-all duration-300 hover:border-[#9b7418] hover:shadow-lg"
              >
                {/* Header */}
                <div className="flex min-h-[64px] items-center gap-3 border-b border-[#dedede] px-4 py-3 sm:px-5">
                ...
                {item.type === "image" ? (
                  ...
                  /* Custom Packaging */
                  <div className="flex min-h-[155px] items-center justify-between gap-3 px-6 py-8 sm:min-h-[165px] sm:px-6">
                    ...
                    <div className="relative h-[120px] w-[95px] shrink-0 sm:h-[160px] sm:w-[120px]">
                      <Image
                        src={item.image}
